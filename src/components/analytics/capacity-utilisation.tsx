        ...
        <div className="space-y-2">
          ...
          <div className="relative h-8 bg-muted rounded-full overflow-hidden">
            ...
            <div className="absolute left-0 top-1/2 -translate-y-1/2 ml-2">
              <div className="bg-background border border-border px-2 py-0.5 rounded text-xs font-bold text-primary">
        ...
        <div className="grid grid-cols-3 gap-4">
          <Card>
            <CardContent className="text-center p-4">
              <div className="text-2xl font-bold mb-1">{data.available.toLocaleString()}</div>
              <div className="text-sm text-muted-foreground">Available Space</div>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="text-center p-4">
              <div className="text-2xl font-bold text-primary mb-1">{data.current}</div>
              <div className="text-sm text-muted-foreground">Currently Stored</div>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="text-center p-4">
